...
void loop() {
  ...
  if(insideSensorReading < baselineInternalReading && (double)insideSensorReading/(double)baselineInternalReading > .2) //if light in bay dims, there is a ball in the bay
  hasBall=true;
  else
  hasBall=false;
